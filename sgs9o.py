...
class Gs9oInitCommand(sublime_plugin.TextCommand):
	def run(self, edit, wd=None):
		...
		if was_empty:
			v.insert(edit, 0, 'SGoSublime %s 9o: type `help` for help and command documentation\n\n' % about.VERSION)
...
def cmd_go(view, edit, args, wd, rkey):
	...
	cid, cb = _9_begin_call('sgo', view, edit, args, wd, rkey, '9go-%s' % wd)
	a = {
		'cid': cid,
		'env': sh.env(),
		'cwd': wd,
...
def _env_settings(d, view, edit, args, wd, rkey):
	...
	s = '\n'.join((
		'Default Settings file: gs.packages://SGoSublime/SGoSublime.sublime-settings (do not edit this file)',
		'User settings file: gs.packages://User/SGoSublime.sublime-settings (add/change your settings here)',
